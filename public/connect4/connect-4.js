...
// include: /tmp/tmp_oi0actx.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'connect-4.data';
      var REMOTE_PACKAGE_BASE = 'connect-4.data';
...
Module['FS_createPath']("/src", "images", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_connect-4.data');

      };
      Module['addRunDependency']('datafile_connect-4.data');
    ...
    loadPackage({"files": [{"filename": "/src/Hyperspace.ttf", "start": 0, "end": 22016}, {"filename": "/src/images/empty-tile.png", "start": 22016, "end": 22372}, {"filename": "/src/images/red-tile.png", "start": 22372, "end": 23282}, {"filename": "/src/images/red.png", "start": 23282, "end": 24086}, {"filename": "/src/images/yellow-tile.png", "start": 24086, "end": 24853}, {"filename": "/src/images/yellow.png", "start": 24853, "end": 25512}], "remote_package_size": 25512});

  })();

// end include: /tmp/tmp_oi0actx.js
// include: /tmp/tmp1ixp5zbi.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp1ixp5zbi.js
// include: /tmp/tmp9uuqvcdj.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp9uuqvcdj.js
...
function findWasmBinary() {
    return locateFile('connect-4.wasm');
}
...
var ASM_CONSTS = {
 ...
 386674: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 386757: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 386826: () => { return window.innerWidth; },  
 386856: () => { return window.innerHeight; }
};
